...
func TestGoBuildIsSupportedRef(t *testing.T) {
	...
	for _, importpath := range []string{
		filepath.FromSlash("github.com/aaron-prindle/go-containerregistry/cmd/crane"),
		filepath.FromSlash("github.com/aaron-prindle/go-containerregistry/cmd/ko"),
		filepath.FromSlash("github.com/aaron-prindle/go-containerregistry/vendor/k8s.io/code-generator/cmd/deepcopy-gen"), // vendored commands work too.
	} {
	...
	for _, importpath := range []string{
		filepath.FromSlash("github.com/aaron-prindle/go-containerregistry/v1/remote"), // not a command.
		filepath.FromSlash("github.com/aaron-prindle/go-containerregistry/pkg/foo"),   // does not exist.
	} {
		t.Run(importpath, func(t *testing.T) {
			if ng.IsSupportedReference(importpath) {
...
func TestGoBuildNoKoData(t *testing.T) {
	...
	importpath := "github.com/aaron-prindle/go-containerregistry"
